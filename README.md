...
In this challenge, we had to make three boxes that hovered change color, with a toggle button that changes the price from monthly to annualy.

--FRONTENDMENTOR'S README--
